...
print("-------------------------------------------------------------------------User 432 had already liked:-------------------------------------------------------")
...
print("-----------------------------------------------------Recommended movies for User 432 :------------------------------------------------------")
...
print("______________________________________________________________________________")
print("-------------------------------------------------Some of User 432's held-out movies (movies liked by user present in test dataset of our model)-------------------------------------------------------")
print("______________________________________________________________________________")
